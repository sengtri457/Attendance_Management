...
router.put("/:id", authMiddleware, roleCheck("Admin"), userController.updateUser);
router.delete("/:id", authMiddleware, roleCheck("Admin"), userController.deleteUser);
router.patch("/:id/toggle-status", authMiddleware, roleCheck("Admin"), userController.toggleUserStatus);
